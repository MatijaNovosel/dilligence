		...
		<q-card :style="$q.screen.xs || $q.screen.sm || dialogStyle">
			...
			<q-card-section v-if="taskInfo">
				...
				<div>
					...
					<q-list dense :style="$q.screen.xs || $q.screen.sm ? fileListStyleSmall : fileListStyleNormal">
						<q-item
						...
						>
							...
							<q-item-section class="text-subtitle2" side>{{ attachment.size | byteCountToReadableFormat }}</q-item-section>
						</q-item>
					</q-list>
				</div>
			</q-card-section>
