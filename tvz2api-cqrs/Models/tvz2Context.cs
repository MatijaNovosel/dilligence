        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Exam>(entity =>
            {
                ...
                entity.HasOne(d => d.Subject)
                    ...
                    .HasConstraintName("FK__Exam__SubjectID__534D60F1");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.Exam)
                    .HasForeignKey(d => d.UserId)
                    .HasConstraintName("FK__Exam__UserID__52593CB8");
            });
            ...
            modelBuilder.Entity<Izvrsitelj>(entity =>
            {
                ...
                entity.HasOne(d => d.Kolegij)
                    ...
                    .HasConstraintName("FK__Izvrsitel__Koleg__5812160E");

                entity.HasOne(d => d.UlogaIzvrsitelja)
                    .WithMany(p => p.Izvrsitelj)
                    .HasForeignKey(d => d.UlogaIzvrsiteljaId)
                    .HasConstraintName("FK__Izvrsitel__Uloga__59063A47");

                entity.HasOne(d => d.Zaposlenik)
                    .WithMany(p => p.Izvrsitelj)
                    .HasForeignKey(d => d.ZaposlenikId)
                    .HasConstraintName("FK__Izvrsitel__Zapos__59FA5E80");
            });
            ...
            modelBuilder.Entity<Kolegij>(entity =>
            {
                ...
                entity.HasOne(d => d.Smjer)
                    ...
                    .HasConstraintName("FK__Kolegij__SmjerID__5AEE82B9");
            });
            ...
            modelBuilder.Entity<Message>(entity =>
            {
                ...
                entity.HasOne(d => d.Chat)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Message__ChatID__693CA210");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.Message)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Message__UserID__6A30C649");
            });
            ...
            modelBuilder.Entity<Pretplata>(entity =>
            {
                ...
                entity.HasOne(d => d.Kolegij)
                    ...
                    .HasForeignKey(d => d.KolegijId)
                    .HasConstraintName("FK__Pretplata__Koleg__5BE2A6F2");

                entity.HasOne(d => d.Student)
                    .WithMany(p => p.Pretplata)
                    .HasForeignKey(d => d.StudentId)
                    .HasConstraintName("FK__Pretplata__Stude__5CD6CB2B");
            });
            ...
            modelBuilder.Entity<SidebarContent>(entity =>
            {
                ...
                entity.HasOne(d => d.Kolegij)
                    ...
                    .HasForeignKey(d => d.KolegijId)
                    .HasConstraintName("FK__SidebarCo__Koleg__5DCAEF64");
            });
            ...
            modelBuilder.Entity<SidebarContentFile>(entity =>
            {
                ...
                entity.HasOne(d => d.File)
                    ...
                    .HasConstraintName("FK__SidebarCo__FileI__66603565");

                entity.HasOne(d => d.SidebarContent)
                    .WithMany(p => p.SidebarContentFile)
                    .HasForeignKey(d => d.SidebarContentId)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("FK__SidebarCo__Sideb__656C112C");
            });
            ...
            modelBuilder.Entity<Student>(entity =>
            {
                ...
                entity.HasOne(d => d.Smjer)
                    ...
                    .HasForeignKey(d => d.SmjerId)
                    .HasConstraintName("FK__Student__SmjerID__5EBF139D");
            });
            ...
            modelBuilder.Entity<StudentKolegij>(entity =>
            {
                ...
                entity.HasOne(d => d.Kolegij)
                    ...
                    .HasForeignKey(d => d.KolegijId)
                    .HasConstraintName("FK__StudentKo__Koleg__5FB337D6");

                entity.HasOne(d => d.Student)
                    .WithMany(p => p.StudentKolegij)
                    .HasForeignKey(d => d.StudentId)
                    .HasConstraintName("FK__StudentKo__Stude__60A75C0F");
            });
            ...
            modelBuilder.Entity<UserPrivileges>(entity =>
            {
                ...
                entity.HasOne(d => d.Privilege)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__UserPrivi__Privi__6C190EBB");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.UserPrivileges)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__UserPrivi__UserI__6B24EA82");
            });
            ...
            modelBuilder.Entity<UserSettings>(entity =>
            {
                ...
                entity.HasOne(d => d.User)
                    ...
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__UserSetti__UserI__6D0D32F4");
            });
            ...
            modelBuilder.Entity<Vijest>(entity =>
            {
                ...
                entity.HasOne(d => d.Kolegij)
                    .WithMany(p => p.Vijest)
                    .HasForeignKey(d => d.KolegijId)
                    .HasConstraintName("FK__Vijest__KolegijI__619B8048");

                entity.HasOne(d => d.Objavio)
                    .WithMany(p => p.Vijest)
                    .HasForeignKey(d => d.ObjavioId)
                    .HasConstraintName("FK__Vijest__ObjavioI__628FA481");
            });
            ...
            modelBuilder.Entity<Zaposlenik>(entity =>
            {
                ...
                entity.HasOne(d => d.Odjel)
                    ...
                    .HasConstraintName("FK__Zaposleni__Odjel__6383C8BA");

                entity.HasOne(d => d.VrstaZaposljenja)
                    .WithMany(p => p.Zaposlenik)
                    .HasForeignKey(d => d.VrstaZaposljenjaId)
                    .HasConstraintName("FK__Zaposleni__Vrsta__6477ECF3");
            });
